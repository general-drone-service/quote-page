...
export const DIRT_TYPE_OPTIONS: { value: DirtType; label: string; emoji: string; surcharge: number }[] = [
  { value: "dust",    label: "灰塵",      emoji: "💨", surcharge: 1  },
  { value: "scale",   label: "水垢",      emoji: "🟤", surcharge: 5 },
  { value: "mold",    label: "黑黴",      emoji: "🟢", surcharge: 2.5 },
  { value: "bird",    label: "鳥屎",      emoji: "🐦", surcharge: 2.5 },
  { value: "exhaust", label: "排煙汙垢",  emoji: "🏭", surcharge: 4  },
