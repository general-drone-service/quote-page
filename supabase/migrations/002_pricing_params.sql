...
values (
  ...
  '{
    ...
    "complexity_surcharge": {"light": 0, "medium": 5, "heavy": 8},
    "contamination_surcharge": {"dust": 1, "scale": 5, "bird": 2.5, "mold": 2.5, "exhaust": 4, "grease": 5},
    "contamination_cap": 12,
    "cleaning_agent_surcharge": {"soft": 1, "standard": 1.5, "deep": 3},
    "facade_surcharges": {"road_closure": 3.5, "tight_perimeter": 5, "high_risk_env": 5, "adjacent_trees": 2.5, "tree_extra": 5},
